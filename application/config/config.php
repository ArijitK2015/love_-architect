...
//Config main base url
$config['main_base_url']  =  ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ?  "https" : "http");
$config['main_base_url'] .=  "://".$_SERVER['HTTP_HOST'];
$config['main_base_url'] .=  str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
