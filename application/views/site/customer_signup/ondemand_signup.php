	...
	<div data-role="page" id="signupPage" class="main-page map-page">
				...
				<div class="close-para">
					<div id="info_content">
						<div class="terms-scroll custom-scrollbar">
							<div class="terms-content" style="background: #fff;"> <?php echo str_replace('\n', '<br>', $terms_condition) ?> </div>
						</div>
					</div>
				</div>
		...
		<div data-role="main" class="ui-content login-content homepage-content">
			...
			<div class="ship-wrap">
				...
				<form id="customer-signup-form" name="customer-signup-form" action="<?php echo base_url().'customer-ondemand-submit' ?>" method="post" enctype="multipart/form-data" data-ajax="false">
						...
						<div class="step-form">
							<div class="delivery-options sending-options">
								...
								<div class="guranteed-row all-country-div"  style="display: none">
									...
									<input id="is_fragile1" name="is_fragile" autocomplete="off" value="1" type="radio" checked data-role="none" />
									<label for="is_fragile1">Yes</label>
										
									<input id="is_fragile2" name="is_fragile" autocomplete="off" value="0" type="radio" data-role="none" />
			...
			google.maps.event.addListener(k, "places_changed", function() {
				...
				if (e.length > 0) {
					...
					//if (set_id == 'dropoff_')
					{
						...
						//console.log('p: '+pick_up_addr_valid+' d: '+drop_of_addr_valid);	
