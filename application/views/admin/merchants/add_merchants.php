					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="form">
								...
								<form class="cmxform form-horizontal " id="user_info" method="post" action="<?php echo base_url(); ?>Manage_merchant_controller/add_merchant" enctype="multipart/form-data">
								<input type="hidden" name="field_count" id="field_count" value="1" />
									...
									//For all fixed mandatory field
										if(count($all_fields_fixed)>0)
										{
											...
											foreach($all_fields_fixed as $fixed)
											{
												...
												$addr_lat_long 	= ($field_type == 'address') ? '<label for="'.$field_id.'" class="error" id="'.$field_id.'_is_proper_add_error"></label><input type="hidden" id="'.$field_id.'_lat" name="fixed_fields['.$field_name.'][lat]'.'" value="" /><input type="hidden" id="'.$field_id.'_long" name="fixed_fields['.$field_name.'][long]'.'" value="" /><input type="hidden" class="is_proper" id="'.$field_id.'_is_proper" name="'.$field_id.'_is_proper" value="0" />' : '';
															...
															<div class="col-md-9">
																<div class="fileupload fileupload-new" data-provides="fileupload">
																	<div class="fileupload-preview thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;">
																		<img src="'.base_url().'assets/site/images/transparent.png" alt="">																</div>
																	<div>
									...
									<div class="form-group ">
										...
										<div class="col-lg-4">
											<p><img src="<?php echo base_url().'assets/site/images/transparent.png';?>" alt="" /></p>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<div class="input-group">
												<input class="form-control filterme" id="platform_fee" name="platform_fee" autocomplete="off" value="" type="text" placeholder="" aria-describedby="basic-addon2" required>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<input class=" form-control" name="stripe_live_secret_key" value="" type="text" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<input class=" form-control" name="stripe_live_public_key" value="" type="text" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<input class=" form-control" name="stripe_sandbox_secret_key" value="" type="text" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<input class=" form-control" name="stripe_sandbox_public_key" value="" type="text" />
									</div>
								</div>
									<div class="form-group ">
