...
|-->
	...
	<script>
		...
		function remove_main(url)
		{
			...
			if(r === true)
				window.location = '<?php echo base_url() ?>control/manage-types/delete/'+url;
		}
	</script>

	<form name="frm_opt" action="<?php echo base_url().'control/manage-types/edit'; ?>" method="POST">
				...
				<div class="col-sm-12">
					<section class="panel">
						...
						<div class="panel-body">
							<div class="clearfix">
								<div class="btn-group">
									<button id="editable-sample_new" class="btn btn-primary" onclick="location.href='<?php echo site_url('control'); ?>/manage-types/add';">
										<a href="javascript:void(0);">Add Type<i class="fa fa-plus"></i></a>
									</button>
								</div>
							</div>
