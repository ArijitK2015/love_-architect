				...
				<div class="col-lg-12">
					<section class="panel">
						...
						<div class="panel-body">
							<div class="form">
								<form class="cmxform form-horizontal " id="user_info" method="post" action="<?php echo base_url(); ?>Manage_types_controller/updt" enctype="multipart/form-data">
								<input type="hidden" name="edit_type_id" id="edit_type_id" value="<?php echo isset($type_details[0]['_id']) ? strval($type_details[0]['_id']) : '0'; ?>" />
									...
									<div class="form-group ">
										...
										<div class="col-lg-6">
											<input class="form-control " id="title" name="title" autocomplete="off" maxlength="255" value="<?php echo isset($type_details[0]['title']) ? $type_details[0]['title'] : ''; ?>" type="text" placeholder="" required>
										</div>
									</div>
									...
									<div class="form-group hide">
										...
										<div class="col-lg-6">
											<textarea class="form-control " id="help_txt" name="help_txt" autocomplete="off" type="text" placeholder="Details about this type" ><?php echo isset($type_details[0]['help_txt']) ? $type_details[0]['help_txt'] : ''; ?></textarea>
										</div>
									</div>
