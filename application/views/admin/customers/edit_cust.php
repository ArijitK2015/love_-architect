									...
									?>
												<div class="form-group" id="ex_flds_<?php echo $k+1 ?>">
													...
													<div class="col-lg-6">
														<div class="clearfix">
															<div class="input-group col-sm-9" style="float: left">
																<input class="form-control" required name="old_field[]" id="old_field<?php echo $k+1 ?>" value="<?php echo (isset($field['field_name']) && (!empty($field['field_name']))) ? $field['field_name'] : '' ?>" aria-describedby="basic-addon2" type="text" />
																...
																<input id="old_field_id_<?php echo $k+1 ?>" name="old_field_id[]" value="<?php echo (isset($field['id']) && (!empty($field['id']))) ? $field['id'] : '0' ?>" type="hidden" />
															...
															<div class="col-sm-1">
																<input type="checkbox" class="form-control" name="field_option_check[<?php echo $k ?>]" id="old_field_option_check_<?php echo $k+1 ?>" value="1" <?php echo (isset($field['is_checked']) && ($field['is_checked'] == '1')) ? 'checked' : ''; ?> />
															</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<div class="clearfix">
												...
												<div class="col-sm-1">
													<input type="checkbox" class="form-control" name="field_option_check[<?php echo count($all_details) ?>]" id="field_option_check_<?php echo count($all_details) + 1 ?>" value="1" />
												</div>
