	...
	<section id="main-content">
		<section class="wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<section class="panel">
						<header class="panel-heading"> Update Merchant </header>
						<div class="panel-body">
							<div class="form">
								<form class="cmxform form-horizontal " id="user_info" method="post" action="<?php echo base_url(); ?>control/myaccount/updt" enctype="multipart/form-data">
									...
									<?php
										...
										if(count($all_fields_fixed)>0)
										{
											...
											foreach($all_fields_fixed as $fixed)
											{
												...
												{
													$user_image = ($value != '') ? assets_url().'uploads/merchant_images/thumb/'.$value : assets_url().'site/images/transparent.png';
									...
									<div class="form-group ">
										...
										<div class="col-lg-4">
											<p><img src="<?php echo (isset($merchant_details[0]['site_fabicon']) && $merchant_details[0]['site_fabicon']!='') ? assets_url().'site/images/'.$merchant_details[0]['site_fabicon'] : assets_url().'site/images/transparent.png'; ?>" alt="" /></p>
...
-->									<div class="form-group ">
									...
									<div class="form-group">
										<div class="col-lg-offset-3 col-lg-6">
											...
											<button class="btn btn-default" type="button" onclick="location.href='<?php echo base_url();?>control/admin-dashboard';">Cancel</button>
										</div>
									</div>
								</form>
							</div>
