	...
	<section id="main-content">
		<section class="wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<section class="panel">
						<header class="panel-heading">Add Drivers</header>
						<div class="panel-body">
							<div class="form">
								<form class="cmxform form-horizontal " id="user_info" method="post" action="<?php echo base_url(); ?>control/manage-drivers/add_driver" enctype="multipart/form-data">
								...
								<input type="hidden" name="field_count" id="field_count" value="1" />
												...
												if($field_type == 'radio' || $field_type == 'checkbox')
												{
													...
													if(!empty($option_types))
													{
														echo '<div class="form-group">';
															...
															echo '<label for="fixed_fields['.$field_name.']" class="error"></label>';
														echo '</div>';
													}
												}
															...
															<div class="col-md-9">
																<div class="fileupload fileupload-new" data-provides="fileupload">
																	<div class="fileupload-preview thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;">
																		<img src="'.assets_url().'site/images/transparent.png" alt="">																</div>
																	<div>
									...
									<?php
										...
										//echo '<pre>'; print_r($all_fields_fixed); echo '</pre>';
